...
public class PushConsumer2 {
	private static final Logger logger = ClientLogger.getLog(PushConsumer2.class);
    public static void main(String[] args) throws InterruptedException, MQClientException {
        DefaultMQPushConsumer consumer = new DefaultMQPushConsumer("c_group_test_3");
        consumer.setNamesrvAddr("10.10.128.90:9876");
        consumer.setInstanceName("consumer_push2");
        /**
         * 订阅指定topic下所有消息
         */
